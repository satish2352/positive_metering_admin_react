...
const Leadership = () => {
  ...
  const validateForm = (formData) => {
    ...
    if (!formData.img) {
      errors.img = "Image is required with 958x641 pixels";
      isValid = false;
    } else if (
      formData.img instanceof File &&
      !validateImageSize(formData.img)
    ) {
      errors.img = "Image is not 958x641 pixels";
      isValid = false;
    }
    ...
    if (!formData.designation?.trim()) {
      errors.address = "Designation is required";
    }
    ...
    if (!formData.facebook?.trim()) {
      errors.address = "Facebook is required";
    }
    if (!formData.instagram?.trim()) {
      errors.address = "Instagram is required";
    }
    if (!formData.linkedin?.trim()) {
      errors.address = "Linkedin is required";
    }
  ...
  const validateImageSize = (file) => {
    return new Promise((resolve, reject) => {
      const img = new Image();
      img.onload = () => {
        if (img.width === 958 && img.height === 641) {
          resolve();
        } else {
          reject("Image must be 958x641 pixels");
        }
      };
          ...
          >
            <button
              ...
              onClick={async () => {
                ...
                try {
                  await instance.delete(`leadership/isdelete-leadership/${id}`, {
                    headers: {
                      Authorization: `Bearer ${accessToken}`,
                      "Content-Type": "application/json",
                    },
          ...
          >
            <button
              ...
              onClick={async () => {
                ...
                try {
                  await instance.put(
                    `leadership/isactive-leadership/${id}`,
                    { isVisible },
                    {
                      headers: {
                        Authorization: `Bearer ${accessToken}`,
                  ...
                  <Row>
                    <Col md={12}>
                      ...
                      <NewResuableForm
                        ...
                        error={errors.img}
                        imageDimensiion="Image must be 958*641 pixels"
                      />
