...
const OurTeam = () => {
    ...
    if (validateForm(formData)) {
      try {
        if (editMode) {
          ...
          await axios.post("http://localhost:5000/ourteam", formData);
        ...
        toggleShow();
        setEditMode(false);
        setFormData({ image: "", name: "", designation: "", description: "" }); // Reset form data after submission
      } catch (error) {
  ...
  useEffect(() => {
    if (shows) {
      ...
      setFormData({ image: "", name: "", designation: "", description: "" });
    }
  }, [shows]);
              ...
              <Form onSubmit={handleSubmit}>
                <Row>
                  ...
                  <Col md={6}>
                    ...
                    />
                    {errors.designation && (
                      <span className="error text-danger">{errors.designation}</span>
                    )}
                  </Col>
