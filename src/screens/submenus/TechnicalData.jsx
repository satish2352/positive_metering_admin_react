...
//                 const accessToken = localStorage.getItem("accessToken");
//                 try {
//                   await instance.delete(`technicalData/delete-technical/${id}`, {
//                     headers: {
//                       Authorization: `Bearer ${accessToken}`,
//                       "Content-Type": "application/json",
//                     },
...
//     } else if (name === "technicalDescription") {
//       const charLimit = 1000; // Set your character limit here
//       if (value.length > charLimit) {
//         setErrors((prevErrors) => ({
//           ...prevErrors,
//           technicalDescription: `Character limit of ${charLimit} exceeded`,
//         }));
//       } else {
//         setFormData((prevFormData) => ({ ...prevFormData, [name]: value }));
//         setErrors((prevErrors) => ({ ...prevErrors, technicalDescription: "" }));
//       }
//     } else {
//       setFormData((prevFormData) => ({ ...prevFormData, [name]: value }));
//     }
...
import "../../App.scss";
const TechnicalData = () => {
  const { searchQuery, handleSearch, setData, filteredData } =
    useSearchExport();
  ...
  const tableColumns = (currentPage, rowsPerPage) => [
    ...
    {
      name: <CustomHeader name="Technical Description" />,
      cell: (row) => <span>{row.technicalDescription}</span>,
    },
    {
